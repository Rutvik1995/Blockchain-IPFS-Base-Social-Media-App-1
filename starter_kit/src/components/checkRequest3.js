...
class checkRequest3  extends Component{
    ...
    constructor(props){
      ...
      async loadBlockChainData(){
        ...
        this.setState({userPrivateKey:response.SecretString});
...
///
  ...
  <div className="container">
          ...
          <div className="media-content">
            ...
            <br></br>
            <Card.Link onClick={() => this.acceptFriendRequestModel(people)}><Button variant="primary" size="sm" >Accept</Button></Card.Link>
        ...
        return(
          ...
          {list}
                ...
                <Modal show={this.state.showModal} onHide={this.closeModal}  size="lg">
                  ...
                  <Modal.Footer>
                  <Button onClick={() => this.acceptFriendRequest(this.state.friendData)}>Yes</Button>
                </Modal.Footer>
              </Modal>
